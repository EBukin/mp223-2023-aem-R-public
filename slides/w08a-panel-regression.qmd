...
-   Panel Regression **Fixed Effect**:
    ...
    -   **First-difference**, Between transformation (look it up in [@Croissant2018])
...
-   We assume the OVB to be time-invariant [@Mundlak1961].
...
## Fixed Effect Model: First Difference transformation
